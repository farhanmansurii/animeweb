...
const Navbar1 = () => {
  ...
  return (
    <div>
      <nav className="flex items-center justify-between  z-[100] w-full  bg-slate-500">
            ...
            <div className="md:hidden" id="mobile-menu">
              <div ref={ref} className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                {data.map((e) => (
                  <>
                    <Link href={e.link}>
                      <div className="text-gray-200 hover:bg-gray-700 duration-150 hover:text-white block px-3 py-2 rounded-md text-base font-medium">
                        {e.name}
                      </div>
                    </Link>
                  </>
