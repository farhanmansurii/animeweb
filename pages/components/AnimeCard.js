  ...
  return (
    <>
      <Link href={`/details?id=${id}`}> 
        ...
        <Box display='flex' height={[266.7,311.1,355.6]} textAlign='center' borderRadius='xl'  _hover={{ border:'5px solid gray', transition:'0.7'  } } flexDir='column-reverse' bgSize='cover' bgRepeat="no-repeat" mt='4rem' flexWrap='nowrap' w={[150, 175, 200]} zalignSelf='center' backgroundImage={animeImg} bgPos='center' >
