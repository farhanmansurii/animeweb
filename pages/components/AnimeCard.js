  ...
  return (
    <>
      <Link href={`/details?id=${id}`}>
        <div
          className="flex flex-col-reverse bg-cover ease-in transform sm:hover:scale-105  hover: w-[150px] h-[213.60px] bg-center bg-no-repeat whitespace-nowrap "
        ...
        >
          <div className=" bg-gradient-to-t mt-30  from-black to-transparent">
            <div className="flex flex-row justify-between my-4">
              ...
              <div className=" text-black bg-white py-1 px-2  rounded-lg  text-xs w-fit mr-2  h-fit p-2rounded-2xl place-self-end  ">
                {rating} ★{" "}
              </div>
            </div>
          </div>
