...
function AnimeCard({ animeImg, title, id }) {
  return (
    <>
      ...
      <Box display='flex' height='300px' textAlign='center' borderRadius='xl' flexDir='column-reverse' bgSize='cover' bgRepeat="no-repeat" mt='4rem'  width={['180px', null, '200px']} alignSelf='center' backgroundImage={animeImg} bgPos='center' >
